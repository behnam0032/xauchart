import{r as d,i as c,a as o}from"./clock-CCwc8sip.js";import{a as n,b as h}from"./seo-BHAbaErS.js";let i=!1;function p(){if(i)return;i=!0;const e=document.querySelectorAll(".anchor-link");e.length!==0&&e.forEach(a=>{a.addEventListener("click",async t=>{t.preventDefault();const s=a.getAttribute("href");if(!s)return;const r=window.location.origin+window.location.pathname+s;await f(r)&&u(a);const l=document.querySelector(s);l&&setTimeout(()=>{l.scrollIntoView({behavior:"smooth",block:"start"})},100)})})}async function f(e){try{if(navigator.clipboard&&window.isSecureContext)return await navigator.clipboard.writeText(e),!0}catch(a){console.warn("Clipboard API failed, using fallback:",a)}try{const a=document.createElement("textarea");a.value=e,a.style.cssText="position:fixed;opacity:0;left:-9999px",document.body.appendChild(a),a.focus(),a.select();const t=document.execCommand("copy");return document.body.removeChild(a),t}catch(a){return console.error("Fallback copy failed:",a),!1}}function u(e){const a=e.textContent;e.className,e.textContent="✓",e.classList.add("copied"),setTimeout(()=>{e.textContent=a,e.classList.remove("copied")},1500)}document.getElementById("app").innerHTML=d("learn")+`
<main class="main">
...
`;c();o();p();n({headline:"اسپرد طلا چیست؟ آموزش کامل Spread در معاملات XAU/USD",description:"آموزش کامل اسپرد طلا، تفاوت اسپرد ثابت و شناور و نحوه کاهش هزینه معاملات",datePublished:"2026-07-29"});h([{q:"آیا اسپرد همیشه ثابت است؟",a:"خیر، در بیشتر بروکرها اسپرد شناور است و با شرایط بازار تغییر می‌کند."},{q:"آیا اسپرد روی حد سود تأثیر دارد؟",a:"بله، معامله ابتدا باید هزینه اسپرد را جبران کند."},{q:"بهترین زمان برای اسپرد پایین؟",a:"ساعات هم‌پوشانی سشن لندن و نیویورک."}]);
