import{r as a}from"./header-D8et95xw.js";import{a as t,b as s}from"./seo-BHAbaErS.js";document.getElementById("app").innerHTML=a("learn")+`
<main class="main">
  <article class="article-content">
    ...
    <h2>مثال ساده از اسپرد طلا</h2>
    <p>فرض کنید قیمت لحظه‌ای طلا به شکل زیر باشد:</p>
    <table class="data-table"><thead><tr><th>نوع قیمت</th><th>مقدار</th></tr></thead><tbody><tr><td>Bid</td><td>3345.20</td></tr><tr><td>Ask</td><td>3345.50</td></tr></tbody></table>
    ...
    <h2>چرا بروکر اسپرد دریافت می‌کند؟</h2>
    ...
    <h2>چه عواملی باعث افزایش اسپرد طلا می‌شوند؟</h2>
    ...
    <h2>اسپرد مناسب برای طلا چقدر است؟</h2>
    <table class="data-table"><thead><tr><th>اسپرد</th><th>وضعیت</th></tr></thead><tbody><tr><td>کمتر از 20 پوینت</td><td class="status-good">عالی</td></tr><tr><td>20 تا 35 پوینت</td><td class="status-ok">مناسب</td></tr><tr><td>35 تا 50 پوینت</td><td class="status-average">متوسط</td></tr><tr><td>بیشتر از 50 پوینت</td><td class="status-bad">زیاد</td></tr></tbody></table>

    <h2>تفاوت اسپرد ثابت و شناور</h2>
    <div class="pros-cons">
      <div class="pros"><h4>✅ اسپرد ثابت</h4><ul><li>قابل پیش‌بینی</li><li>مناسب مبتدی‌ها</li></ul></div>
      <div class="cons"><h4>❌ اسپرد شناور</h4><ul><li>هنگام اخبار چند برابر می‌شود</li><li>غیرقابل پیش‌بینی</li></ul></div>
    </div>

    <h2>چگونه اسپرد کمتری پرداخت کنیم؟</h2>
    <ul class="check-list">
    ...
    <h2>سوالات متداول</h2>
    <div class="faq-item"><h3>آیا اسپرد همیشه ثابت است؟</h3><p>خیر، در بیشتر بروکرها اسپرد شناور است و با شرایط بازار تغییر می‌کند.</p></div>
    <div class="faq-item"><h3>آیا اسپرد روی حد سود تأثیر دارد؟</h3><p>بله، معامله ابتدا باید هزینه اسپرد را جبران کند.</p></div>
    <div class="faq-item"><h3>بهترین زمان برای اسپرد پایین؟</h3><p>ساعات هم‌پوشانی سشن لندن و نیویورک.</p></div>
...
</main>`;t({headline:"اسپرد طلا چیست؟ آموزش کامل Spread در معاملات XAU/USD",description:"آموزش کامل اسپرد طلا، تفاوت اسپرد ثابت و شناور",datePublished:"2026-07-09"});s([{q:"آیا اسپرد همیشه ثابت است؟",a:"خیر، در بیشتر بروکرها اسپرد شناور است."},{q:"آیا اسپرد روی حد سود تأثیر دارد؟",a:"بله، معامله ابتدا باید هزینه اسپرد را جبران کند."},{q:"بهترین زمان برای اسپرد پایین؟",a:"ساعات هم‌پوشانی سشن لندن و نیویورک."}]);
