import{r as a,i as c}from"./market-DaRiDYB7.js";/* empty css                */import{i}from"./clock-DmW530F7.js";document.getElementById("app").innerHTML=a("learn")+`
<main class="main">
  <div class="page-header">
    <h1>📚 آموزش فارکس و معاملات طلا</h1>
    <p>مجموعه مقالات آموزشی برای معامله‌گران از مبتدی تا حرفه‌ای</p>
  </div>
  ...
  <div class="articles-grid">
    ...
    <a href="/learn/risk-management" class="article-card">
      ...
      <span class="article-card-meta">⏱ ۱۲ دقیقه · همه سطوح</span>
    </a>

    <div class="article-card coming-soon">
      <div class="article-card-icon">🕐</div>
      <h3>بهترین زمان معامله طلا</h3>
      <p>سشن‌های معاملاتی و ساعات طلایی برای ترید</p>
      <span class="article-card-meta">به زودی</span>
    </div>

    <div class="article-card coming-soon">
      <div class="article-card-icon">📊</div>
      <h3>مارجین در فارکس</h3>
      <p>آموزش کامل مارجین، لوریج و لیکوئیدیشن</p>
      <span class="article-card-meta">به زودی</span>
    </div>
  </div>
</main>`;i();c();
